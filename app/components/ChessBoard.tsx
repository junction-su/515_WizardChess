...
export default function ChessBoard({
  ...
  return (
    // White card wrapper
    <div className="bg-white rounded-3xl lg:rounded-[40px] pt-1.5 pl-1.5 sm:pt-2.5 sm:pl-2.5 lg:pt-5 lg:pl-5 xl:pt-6 xl:pl-6 pb-5 pr-5 sm:pb-6 sm:pr-6 md:pb-5 md:pr-5 lg:pb-8 lg:pr-8 xl:pb-10 xl:pr-10 shadow-lg select-none">
