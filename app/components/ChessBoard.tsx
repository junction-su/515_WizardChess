...
export default function ChessBoard({
  ...
  return (
    // White card wrapper
    <div className="bg-white rounded-3xl lg:rounded-[40px] pt-3 pl-3 pb-5 pr-5 sm:pb-6 sm:pr-6 md:pb-5 md:pr-5 lg:pb-8 lg:pr-8 xl:pb-10 xl:pr-10 shadow-lg select-none">
